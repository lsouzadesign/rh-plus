    ...
    <div className="fixed inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="text-center text-white match-animation">
        ...
        <div className="mt-8 flex justify-center items-center gap-4">
          <Image src="https://placehold.co/128x128/e0e7ff/4338ca?text=AC" width={128} height={128} className="w-24 h-24 rounded-full ring-4 ring-white" alt="Foto do Candidato" />
          <Image src={matchedJob.companyLogo.replace('400x300', '128x128')} width={128} height={128} className="w-24 h-24 rounded-full ring-4 ring-white" alt="Logo da Empresa" />
        </div>
